...
import { FiInfo, FiMessageCircle, FiX } from 'react-icons/fi'; // Added FiX for a potential close button if used standalone
...
// Dummy FiLoader for illustration if not already imported elsewhere
const FiLoader = ({ className, size }: { className?: string, size?: number }) => (
